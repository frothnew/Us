...
var canvas = document.getElementById("bgHeart");
var ctx = canvas.getContext("2d");
var c = document.getElementById("bgHeart");
var w, h;
var pi = Math.PI;
var all_attribute = {
	num: 2, // 个数
	start_probability: 0.1, // 如果数量小于num，有这些几率添加一个新的     		     
	size_min: 0.3, // 初始爱心大小的最小值
	size_max: 0.6, // 初始爱心大小的最大值
	size_add_min: 0.05, // 每次变大的最小值（就是速度）
	size_add_max: 0.1, // 每次变大的最大值
	opacity_min: 0.3, // 初始透明度最小值
	opacity_max: 0.5, // 初始透明度最大值
	opacity_prev_min: .003, // 透明度递减值最小值
	opacity_prev_max: .005, // 透明度递减值最大值
	light_min: 0, // 颜色亮度最小值
	light_max: 10, // 颜色亮度最大值
};
...
function start() {
	...
	style_color += 0.1;
	//更改背景色hsl(颜色值，饱和度，明度)
	ctx.fillStyle = 'hsl(' + style_color + ',100%,97%,0.8)';
...
ready_run.prototype = {
	to_reset: function() {
		...
		t.opacity_change = find_random(all_attribute.opacity_prev_min, all_attribute
			.opacity_prev_max);
